...
wget http://10.108.119.234/chfs/shared/Temp/mini5Gcore/setup_env/install-replace.sh
sudo mv mininet/util/install.sh mininet/util/install.sh.bak 
sudo mv ./install-replace mininet/util/install.sh
